...
public class FunctionAnalysis {
    ...
    public String functionAnalysis(String userMessage) {
        ...
        if (TextUtils.isEmpty(changeMaxFeedback)) {
            ...
            if (userMessage.contains("开灯模式一")||userMessage.contains("开一下灯")) {
                return "已经帮你准备好了，点击进入开灯模式一YY了哦。~";
            }else if (userMessage.contains("关灯")) {
                return "已经帮你准备好了，点击就可以帮你关灯YY了哦。~";
            ...
            }else if(userMessage.contains("开灯模式二")){
                return "已经帮你准备好了，点击进入开灯模式二YY了哦。~";
            }else if(userMessage.contains("开灯模式三")){
                return "已经帮你准备好了，点击进入开灯模式三YY了哦。~";
            }
